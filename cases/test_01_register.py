...
do_excel = HandleExcel(os.path.join(DATAS_DIR,do_config.get_value("file name","cases_file_name")),"register")
...
class TestRegister(unittest.TestCase):
    ...
    def test_register(self,one_case):
        try:
            ...
            new_data = HandleContext.register_parametrize_replace(one_case["data"])
